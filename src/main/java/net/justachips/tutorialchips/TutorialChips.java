package net.justachips.tutorialchips;
...
@Mod(TutorialChips.MOD_ID)
public class TutorialChips
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "tutorialchips";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();



    public TutorialChips()
    {
